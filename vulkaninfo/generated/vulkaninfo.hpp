...
std::string VkFormatString(VkFormat value) {
    switch (value) {
        ...
        case (VK_FORMAT_ASTC_4x4_SFLOAT_BLOCK_EXT): return "FORMAT_ASTC_4x4_SFLOAT_BLOCK_EXT";
        case (VK_FORMAT_ASTC_5x4_SFLOAT_BLOCK_EXT): return "FORMAT_ASTC_5x4_SFLOAT_BLOCK_EXT";
        case (VK_FORMAT_ASTC_5x5_SFLOAT_BLOCK_EXT): return "FORMAT_ASTC_5x5_SFLOAT_BLOCK_EXT";
        case (VK_FORMAT_ASTC_6x5_SFLOAT_BLOCK_EXT): return "FORMAT_ASTC_6x5_SFLOAT_BLOCK_EXT";
        case (VK_FORMAT_ASTC_6x6_SFLOAT_BLOCK_EXT): return "FORMAT_ASTC_6x6_SFLOAT_BLOCK_EXT";
        case (VK_FORMAT_ASTC_8x5_SFLOAT_BLOCK_EXT): return "FORMAT_ASTC_8x5_SFLOAT_BLOCK_EXT";
        case (VK_FORMAT_ASTC_8x6_SFLOAT_BLOCK_EXT): return "FORMAT_ASTC_8x6_SFLOAT_BLOCK_EXT";
        case (VK_FORMAT_ASTC_8x8_SFLOAT_BLOCK_EXT): return "FORMAT_ASTC_8x8_SFLOAT_BLOCK_EXT";
        case (VK_FORMAT_ASTC_10x5_SFLOAT_BLOCK_EXT): return "FORMAT_ASTC_10x5_SFLOAT_BLOCK_EXT";
        case (VK_FORMAT_ASTC_10x6_SFLOAT_BLOCK_EXT): return "FORMAT_ASTC_10x6_SFLOAT_BLOCK_EXT";
        case (VK_FORMAT_ASTC_10x8_SFLOAT_BLOCK_EXT): return "FORMAT_ASTC_10x8_SFLOAT_BLOCK_EXT";
        case (VK_FORMAT_ASTC_10x10_SFLOAT_BLOCK_EXT): return "FORMAT_ASTC_10x10_SFLOAT_BLOCK_EXT";
        case (VK_FORMAT_ASTC_12x10_SFLOAT_BLOCK_EXT): return "FORMAT_ASTC_12x10_SFLOAT_BLOCK_EXT";
        case (VK_FORMAT_ASTC_12x12_SFLOAT_BLOCK_EXT): return "FORMAT_ASTC_12x12_SFLOAT_BLOCK_EXT";
        case (VK_FORMAT_G8_B8R8_2PLANE_444_UNORM_EXT): return "FORMAT_G8_B8R8_2PLANE_444_UNORM_EXT";
        case (VK_FORMAT_G10X6_B10X6R10X6_2PLANE_444_UNORM_3PACK16_EXT): return "FORMAT_G10X6_B10X6R10X6_2PLANE_444_UNORM_3PACK16_EXT";
        case (VK_FORMAT_G12X4_B12X4R12X4_2PLANE_444_UNORM_3PACK16_EXT): return "FORMAT_G12X4_B12X4R12X4_2PLANE_444_UNORM_3PACK16_EXT";
        case (VK_FORMAT_G16_B16R16_2PLANE_444_UNORM_EXT): return "FORMAT_G16_B16R16_2PLANE_444_UNORM_EXT";
        case (VK_FORMAT_A4R4G4B4_UNORM_PACK16_EXT): return "FORMAT_A4R4G4B4_UNORM_PACK16_EXT";
        case (VK_FORMAT_A4B4G4R4_UNORM_PACK16_EXT): return "FORMAT_A4B4G4R4_UNORM_PACK16_EXT";
...
std::string VkQueueGlobalPriorityEXTString(VkQueueGlobalPriorityEXT value) {
    switch (value) {
        case (VK_QUEUE_GLOBAL_PRIORITY_LOW_EXT): return "QUEUE_GLOBAL_PRIORITY_LOW_EXT";
        case (VK_QUEUE_GLOBAL_PRIORITY_MEDIUM_EXT): return "QUEUE_GLOBAL_PRIORITY_MEDIUM_EXT";
        case (VK_QUEUE_GLOBAL_PRIORITY_HIGH_EXT): return "QUEUE_GLOBAL_PRIORITY_HIGH_EXT";
        case (VK_QUEUE_GLOBAL_PRIORITY_REALTIME_EXT): return "QUEUE_GLOBAL_PRIORITY_REALTIME_EXT";
        default: return std::string("UNKNOWN_VkQueueGlobalPriorityEXT_value") + std::to_string(value);
    }
}
...
std::vector<const char *> VkFormatFeatureFlagBits2KHRGetStrings(VkFormatFeatureFlagBits2KHR value) {
    ...
    if (VK_FORMAT_FEATURE_2_STORAGE_IMAGE_BIT_KHR & value) strings.push_back("FORMAT_FEATURE_2_STORAGE_IMAGE_BIT_KHR");
    if (VK_FORMAT_FEATURE_2_STORAGE_IMAGE_ATOMIC_BIT_KHR & value) strings.push_back("FORMAT_FEATURE_2_STORAGE_IMAGE_ATOMIC_BIT_KHR");
    if (VK_FORMAT_FEATURE_2_UNIFORM_TEXEL_BUFFER_BIT_KHR & value) strings.push_back("FORMAT_FEATURE_2_UNIFORM_TEXEL_BUFFER_BIT_KHR");
    if (VK_FORMAT_FEATURE_2_STORAGE_TEXEL_BUFFER_BIT_KHR & value) strings.push_back("FORMAT_FEATURE_2_STORAGE_TEXEL_BUFFER_BIT_KHR");
    if (VK_FORMAT_FEATURE_2_STORAGE_TEXEL_BUFFER_ATOMIC_BIT_KHR & value) strings.push_back("FORMAT_FEATURE_2_STORAGE_TEXEL_BUFFER_ATOMIC_BIT_KHR");
    if (VK_FORMAT_FEATURE_2_VERTEX_BUFFER_BIT_KHR & value) strings.push_back("FORMAT_FEATURE_2_VERTEX_BUFFER_BIT_KHR");
    if (VK_FORMAT_FEATURE_2_COLOR_ATTACHMENT_BIT_KHR & value) strings.push_back("FORMAT_FEATURE_2_COLOR_ATTACHMENT_BIT_KHR");
    if (VK_FORMAT_FEATURE_2_COLOR_ATTACHMENT_BLEND_BIT_KHR & value) strings.push_back("FORMAT_FEATURE_2_COLOR_ATTACHMENT_BLEND_BIT_KHR");
    if (VK_FORMAT_FEATURE_2_DEPTH_STENCIL_ATTACHMENT_BIT_KHR & value) strings.push_back("FORMAT_FEATURE_2_DEPTH_STENCIL_ATTACHMENT_BIT_KHR");
    if (VK_FORMAT_FEATURE_2_BLIT_SRC_BIT_KHR & value) strings.push_back("FORMAT_FEATURE_2_BLIT_SRC_BIT_KHR");
    if (VK_FORMAT_FEATURE_2_BLIT_DST_BIT_KHR & value) strings.push_back("FORMAT_FEATURE_2_BLIT_DST_BIT_KHR");
    if (VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_LINEAR_BIT_KHR & value) strings.push_back("FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_LINEAR_BIT_KHR");
    if (VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_CUBIC_BIT_EXT & value) strings.push_back("FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_CUBIC_BIT_EXT");
    if (VK_FORMAT_FEATURE_2_TRANSFER_SRC_BIT_KHR & value) strings.push_back("FORMAT_FEATURE_2_TRANSFER_SRC_BIT_KHR");
    if (VK_FORMAT_FEATURE_2_TRANSFER_DST_BIT_KHR & value) strings.push_back("FORMAT_FEATURE_2_TRANSFER_DST_BIT_KHR");
    if (VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_MINMAX_BIT_KHR & value) strings.push_back("FORMAT_FEATURE_2_SAMPLED_IMAGE_FILTER_MINMAX_BIT_KHR");
    if (VK_FORMAT_FEATURE_2_MIDPOINT_CHROMA_SAMPLES_BIT_KHR & value) strings.push_back("FORMAT_FEATURE_2_MIDPOINT_CHROMA_SAMPLES_BIT_KHR");
    if (VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_LINEAR_FILTER_BIT_KHR & value) strings.push_back("FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_LINEAR_FILTER_BIT_KHR");
    if (VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_SEPARATE_RECONSTRUCTION_FILTER_BIT_KHR & value) strings.push_back("FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_SEPARATE_RECONSTRUCTION_FILTER_BIT_KHR");
    if (VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_BIT_KHR & value) strings.push_back("FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_BIT_KHR");
    if (VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT_KHR & value) strings.push_back("FORMAT_FEATURE_2_SAMPLED_IMAGE_YCBCR_CONVERSION_CHROMA_RECONSTRUCTION_EXPLICIT_FORCEABLE_BIT_KHR");
    if (VK_FORMAT_FEATURE_2_DISJOINT_BIT_KHR & value) strings.push_back("FORMAT_FEATURE_2_DISJOINT_BIT_KHR");
    if (VK_FORMAT_FEATURE_2_COSITED_CHROMA_SAMPLES_BIT_KHR & value) strings.push_back("FORMAT_FEATURE_2_COSITED_CHROMA_SAMPLES_BIT_KHR");
    if (VK_FORMAT_FEATURE_2_STORAGE_READ_WITHOUT_FORMAT_BIT_KHR & value) strings.push_back("FORMAT_FEATURE_2_STORAGE_READ_WITHOUT_FORMAT_BIT_KHR");
    if (VK_FORMAT_FEATURE_2_STORAGE_WRITE_WITHOUT_FORMAT_BIT_KHR & value) strings.push_back("FORMAT_FEATURE_2_STORAGE_WRITE_WITHOUT_FORMAT_BIT_KHR");
    if (VK_FORMAT_FEATURE_2_SAMPLED_IMAGE_DEPTH_COMPARISON_BIT_KHR & value) strings.push_back("FORMAT_FEATURE_2_SAMPLED_IMAGE_DEPTH_COMPARISON_BIT_KHR");
...
std::vector<const char *> VkToolPurposeFlagBitsEXTGetStrings(VkToolPurposeFlagBitsEXT value) {
    ...
    if (VK_TOOL_PURPOSE_PROFILING_BIT_EXT & value) strings.push_back("TOOL_PURPOSE_PROFILING_BIT_EXT");
    if (VK_TOOL_PURPOSE_TRACING_BIT_EXT & value) strings.push_back("TOOL_PURPOSE_TRACING_BIT_EXT");
    if (VK_TOOL_PURPOSE_ADDITIONAL_FEATURES_BIT_EXT & value) strings.push_back("TOOL_PURPOSE_ADDITIONAL_FEATURES_BIT_EXT");
    if (VK_TOOL_PURPOSE_MODIFYING_FEATURES_BIT_EXT & value) strings.push_back("TOOL_PURPOSE_MODIFYING_FEATURES_BIT_EXT");
...
#ifdef VK_ENABLE_BETA_EXTENSIONS
        {VK_STRUCTURE_TYPE_QUEUE_FAMILY_QUERY_RESULT_STATUS_PROPERTIES_2_KHR, sizeof(VkQueueFamilyQueryResultStatusProperties2KHR)},
#endif  // VK_ENABLE_BETA_EXTENSIONS
#ifdef VK_ENABLE_BETA_EXTENSIONS
